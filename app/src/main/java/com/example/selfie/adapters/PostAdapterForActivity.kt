...
class PostAdapterForActivity(private val items:ArrayList<Posts>)
    :RecyclerView.Adapter<PostAdapterForActivity.ViewHolder>(){
    ...
    fun getTimeAgo(previousTime: Long): String {
